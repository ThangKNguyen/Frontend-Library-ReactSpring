            ...
            {displayInput && 
                <form method = "POST" action = "#">
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" id="submitReviewDescription" rows={3} onChange={(e) => setReviewDescription(e.target.value)} value={reviewDescription} placeholder="Describe your experience...">
